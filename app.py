...
class RegisterWindow:
    ...
    def register(self):
        ...
        try:
            ...
            # Dùng trực tiếp bảng để tránh phụ thuộc OUT của procedure khi gọi từ Python
            cur.execute("""
    ...
    def login(self):
        ...
        try:
            ...
            if row:
                ...
                self.root.destroy()
                main_root = tk.Tk()
                LibraryApp(main_root, user_id, ten_dang_nhap, vai_tro)
                main_root.mainloop()
            else:
...
class LibraryApp:
    ...
    def add_user(self):
        ...
        username = self.manage_user_username.get().strip()
